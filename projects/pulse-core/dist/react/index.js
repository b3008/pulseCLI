...
__export(react_exports, {
  PulseTerminal: () => PulseTerminal2,
  PulseTerminalElement: () => PulseTerminal,
  _PulseTerminalClass: () => PulseTerminal,
  getThemeNames: () => getThemeNames,
  registerTheme: () => registerTheme,
  unregisterTheme: () => unregisterTheme,
  usePulseRegistry: () => usePulseRegistry,
  usePulseTerminal: () => usePulseTerminal
});
...
var PulseRegistryContext = (0, import_react.createContext)(null);
function usePulseRegistry() {
  return (0, import_react.useContext)(PulseRegistryContext);
}
var PulseTerminal2 = (0, import_react.forwardRef)(function PulseTerminal3({
  prompt,
  welcome,
  maxOutputs,
  theme,
  ...
  const customThemeNameRef = (0, import_react.useRef)(null);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(PulseRegistryContext.Provider, { value: registry, children: [
...
function usePulseTerminal(options = {}) {
  ...
  const addCommand = (0, import_react.useCallback)(
